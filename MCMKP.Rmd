...
Najbolj znan problem v kombinatorični optimizaciji je problem nahrbtnika (PN), ki je definiran takole: Nahrbtnik s kapaciteto $C>0$ in naborom predmetov $I={1,…,n}$, z vrednostjo $p_i≥0$ in težo $w_i≥0$. Iščemo maksimalen profit, pri katerem teža nahrbtnika ne presega kapacitete nahrbtnika. Ta problem rešimo s programi mešanega celoštevilskega linearnega programiranja: 
